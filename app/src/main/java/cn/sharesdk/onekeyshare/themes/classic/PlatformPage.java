...
public abstract class PlatformPage extends OnekeySharePage {
	...
	public void onCreate() {
		...
		LinearLayout.LayoutParams lp22 = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,120);
		lp22.setMargins(20, 20, 20, 20);
		Button button2 = new Button(activity);
		button2.setText("取消分享");
		button2.setTextSize(16);
		button2.setTextColor(Color.BLACK);
		button2.setBackgroundColor(Color.parseColor("#11cd6e"));
