 ...
 */
public class OneFragment extends Fragment implements HomePageListView.OnLoadChangeListener{
    ...
    private void init(View view){
        ...
        queryGoodsBean = new QueryGoodsBean(null,null,null,5,pageNo,pageSize);//5表示按热度排序
    }
