...
import com.school.twohand.fragement.homeChildFragement.BabyPriaseFragment;
import com.school.twohand.fragement.homeChildFragement.TopicPriaseFragment;
...
public class MyPriaseActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    BabyPriaseFragment babyPriaseFragment = new BabyPriaseFragment();
    TopicPriaseFragment topicPriaseFragment = new TopicPriaseFragment();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_priase);
        ...
        fragmentList.add(babyPriaseFragment);
        fragmentList.add(topicPriaseFragment);
