...
public class OrderDetailActivity2 extends AppCompatActivity {
    ...
    public void initView(QueryOrderDetailBean queryOrderDetailBean) {
        ...
        TextView e= (TextView) findViewById(R.id.tv_sum);
        e.setText(""+queryOrderDetailBean.getGoodsPrice());



        TextView g= (TextView) findViewById(R.id.tv_phoneNumber);
        g.setText(""+queryOrderDetailBean.getPhoneNumber());

        TextView h= (TextView) findViewById(R.id.tv_address);
        h.setText(queryOrderDetailBean.getReceiptDetail());

        TextView i= (TextView) findViewById(R.id.tv_sell_name);
        i.setText(queryOrderDetailBean.getSellUserName());

        TextView j= (TextView) findViewById(R.id.tv_orderId);
        j.setText(queryOrderDetailBean.getOrderNumber());
    ...
    public void Detailshow(int orderStateId,ImageView ivbackground1,ImageView ivbackground2,ImageView ivbackground3,ImageView ivbackground4
        ...
        switch (orderStateId){
            case UNPAY:
                ...
                tvtimeState.setText(days + "天" + hours + "时" + minutes + "分后，如果买家仍未付款，订单将自动关闭");
            ...
            case UNSEND:
                ...
                ivbackground4.setVisibility(View.GONE);
                ivbackground5.setVisibility(View.GONE);
                tvorderState.setText("等待卖家发货，请您联系快递公司发货");
            ...
            case UNRECEIVE:
                ...
                ivbackground4.setVisibility(View.GONE);
                ivbackground5.setVisibility(View.GONE);
                tvorderState.setText("等待买卖双方见面交易，提醒买家当面确认收货");
                tvtimeState.setVisibility(View.GONE);
                btn1.setVisibility(View.GONE);
                btn2.setVisibility(View.GONE);
                btn3.setVisibility(View.VISIBLE);
            ...
            case ACHIEVEBUY:
                ...
                tvorderState.setText("交易成功，卖家已评价，等待买家的评价");
                tvtimeState.setVisibility(View.GONE);
                btn1.setVisibility(View.GONE);
                btn2.setVisibility(View.GONE);
                btn3.setVisibility(View.VISIBLE);
            ...
            case CANCEL:
                ...
                ivbackground4.setVisibility(View.GONE);
                ivbackground5.setVisibility(View.GONE);
                tvorderState.setText("卖家关闭了这笔交易");
                tvtimeState.setVisibility(View.GONE);
                btn1.setVisibility(View.GONE);
                btn2.setVisibility(View.GONE);
                btn3.setVisibility(View.GONE);
    ...
    public void btnClick(final QueryOrderDetailBean queryOrderDetailBean, Button btn1, Button btn2, Button btn3){
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (queryOrderDetailBean.getGoodsOrderState().getGoodsOrderStateId()){
                    case UNPAY:
                        new AlertDialog.Builder(OrderDetailActivity2.this)
                                .setTitle("您确认发货吗？")
                                .setPositiveButton("确定",
                                        new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog,
                                                ...
                                                Toast.makeText(OrderDetailActivity2.this,"发货成功",Toast.LENGTH_SHORT).show();
                                            }
            ...
            public void onClick(View v) {
                switch (queryOrderDetailBean.getGoodsOrderState().getGoodsOrderStateId()){
                    case UNPAY:
                        ...
                        Toast.makeText(OrderDetailActivity2.this,"已取消交易",Toast.LENGTH_SHORT).show();
                        break;
                    ...
                    case UNRECEIVE:
                        ...
                        Toast.makeText(OrderDetailActivity2.this,"已提醒买家收货",Toast.LENGTH_SHORT).show();

                        break;
                    case ACHIEVE:
                        changeState(queryOrderDetailBean.getOrderId(),ACHIEVEBUY);
                        Toast.makeText(OrderDetailActivity2.this,"评价成功",Toast.LENGTH_SHORT).show();
                        break;
                }
            }
        });
