 ...
 * “我的粉丝”的activity
 */
public class NumberFansActivity extends AppCompatActivity implements UltraRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_number_fans);
    ...
    private void initData(){
        ...
        requestParams.addQueryStringParameter("flag","2");//flag==1表示查出我关注的用户
        ...
        x.http().get(requestParams, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                if(userAdapter==null){
                    userAdapter = new CommonAdapter<User>(NumberFansActivity.this,userList,R.layout.my_concern_item) {
                        @Override
    ...
    private void loadMoreData(){
        RequestParams requestParams = new RequestParams(NetUtil.url+"QueryUserByFollowFlagServlet");
        requestParams.addQueryStringParameter("userId",user.getUserId()+"");
        requestParams.addQueryStringParameter("flag","2");//flag==2表示查出关注我的用户
        requestParams.addQueryStringParameter("pageNo",pageNo+"");
        requestParams.addQueryStringParameter("pageSize",pageSize+"");
        x.http().get(requestParams, new Callback.CommonCallback<String>() {
            @Override
