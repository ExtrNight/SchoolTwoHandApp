...
public class GoodsClassActivity extends AppCompatActivity {
    ...
    @OnClick({R.id.RelCar, R.id.Relphone, R.id.Relcomputer, R.id.Reldigital, R.id.Reldigit,
            R.id.Relelectrical, R.id.Relsport, R.id.Relclothes, R.id.Relbook, R.id.Relrent,
            R.id.Rellife, R.id.Relother, R.id.iv_classify_return})
